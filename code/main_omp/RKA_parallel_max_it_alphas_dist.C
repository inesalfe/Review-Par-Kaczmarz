...
int main (int argc, char *argv[]) {
	...
	if(argc != 6) {
		...
		cout << "'./bin/RKA_parallel_max_it_alphas_dist.exe <data_set> <n_runs> <M> <N> <max_it_stop>'" << endl;
		exit(1);
	}
	...
	if (matrix_type.compare("dense") == 0) {
		...
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/RKA_parallel_max_it_alphas_dist.exe <data_set> <n_runs> <M> <N> <alpha> <max_it_stop>'" << endl;
		exit(1);
	}

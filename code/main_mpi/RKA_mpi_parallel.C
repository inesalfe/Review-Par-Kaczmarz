...
// mpic++ -o bin/RKA_mpi_parallel.exe main_mpi/RKA_mpi_parallel.C
// mpirun -np 2 ./bin/RKA_mpi_parallel.exe dense 1 1E-10 2000 100
...
int main (int argc, char *argv[]) {
	...
	if(argc != 6) {
		...
		cout << "'mpirun -np <nproc> ./bin/RKA_mpi_parallel.exe <data_set> <n_runs> <eps> <M> <N>'" << endl;
		exit(1);
	}

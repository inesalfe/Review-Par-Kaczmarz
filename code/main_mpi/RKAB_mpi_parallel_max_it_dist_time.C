...
// mpic++ -o bin/RKAB_mpi_parallel_max_it_dist.exe main_mpi/RKAB_mpi_parallel_max_it_dist.C
// mpirun -np 2 ./bin/RKAB_mpi_parallel_max_it_dist.exe dense 1 1E-10 2000 100 20
...
int main (int argc, char *argv[]) {
	...
	if(argc != 7) {
		...
		cout << "'mpirun -np <nproc> ./bin/RKAB_mpi_parallel_max_it_dist_time.exe <data_set> <n_runs> <M> <N> <block_size> <max_it_stop>'" << endl;
		exit(1);
	}

...
// mpic++ -o bin/RKA_mpi_parallel_max_it_dist.exe main_mpi/RKA_mpi_parallel_max_it_dist.C
// mpirun -np 2 ./bin/RKA_mpi_parallel_max_it_dist.exe dense 1 1E-10 2000 100 20
...
int main (int argc, char *argv[]) {
	...
	if(argc != 6) {
		...
		cout << "'mpirun -np <nproc> ./bin/RKA_mpi_parallel_max_it_dist.exe <data_set> <n_runs> <M> <N> <max_it_stop>'" << endl;
		exit(1);
	}

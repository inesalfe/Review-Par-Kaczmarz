...
plt.plot(x_10000, speedup_2_10000, linewidth=1.5, color='purple', label=r'$n = 10000$')
plt.scatter(x_20000, speedup_2_20000, linewidth=1.5, color='blue')
plt.plot(x_20000, speedup_2_20000, linewidth=1.5, color='blue', label=r'$n = 20000$')
plt.grid()
plt.legend()
...
plt.plot(x_10000, speedup_4_10000, linewidth=1.5, color='purple', label=r'$n = 10000$')
plt.scatter(x_20000, speedup_4_20000, linewidth=1.5, color='blue')
plt.plot(x_20000, speedup_4_20000, linewidth=1.5, color='blue', label=r'$n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_10000, speedup_8_10000, linewidth=1.5, color='purple', label=r'$n = 10000$')
plt.scatter(x_20000, speedup_8_20000, linewidth=1.5, color='blue')
plt.plot(x_20000, speedup_8_20000, linewidth=1.5, color='blue', label=r'$n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_10000, speedup_16_10000, linewidth=1.5, color='purple', label=r'$n = 10000$')
plt.scatter(x_20000, speedup_16_20000, linewidth=1.5, color='blue')
plt.plot(x_20000, speedup_16_20000, linewidth=1.5, color='blue', label=r'$n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_1000, speedup_64_1000, linewidth=1.5, color='orange', label=r'$n = 1000$')
plt.scatter(x_4000, speedup_64_4000, linewidth=1.5, color='red')
plt.plot(x_4000, speedup_64_4000, linewidth=1.5, color='red', label=r'$n = 4000$')
plt.scatter(x_10000, speedup_64_10000, linewidth=1.5, color='purple')
plt.plot(x_10000, speedup_64_10000, linewidth=1.5, color='purple', label=r'$n = 10000$')
plt.scatter(x_20000, speedup_64_20000, linewidth=1.5, color='blue')
plt.plot(x_20000, speedup_64_20000, linewidth=1.5, color='blue', label=r'$n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_10000, time_par_1_10000, linewidth=1.5, color='purple', label=r'1 Thread - $n = 10000$')
plt.scatter(x_20000, time_par_1_20000, color='blue')
plt.plot(x_20000, time_par_1_20000, linewidth=1.5, color='blue', label=r'1 Thread - $n = 20000$')
...
plt.plot(x_10000, time_par_2_10000, linestyle='--', linewidth=1.5, color='purple', label=r'2 Threads - $n = 10000$')
plt.scatter(x_20000, time_par_2_20000, color='blue')
plt.plot(x_20000, time_par_2_20000, linestyle='--', linewidth=1.5, color='blue', label=r'2 Threads - $n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_10000, time_par_4_10000, linestyle='--', linewidth=1.5, color='purple', label=r'4 Threads - $n = 10000$')
plt.scatter(x_20000, time_par_4_20000, color='blue')
plt.plot(x_20000, time_par_4_20000, linestyle='--', linewidth=1.5, color='blue', label=r'4 Threads - $n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_10000, time_par_8_10000, linestyle='--', linewidth=1.5, color='purple', label=r'8 Threads - $n = 10000$')
plt.scatter(x_20000, time_par_8_20000, color='blue')
plt.plot(x_20000, time_par_8_20000, linestyle='--', linewidth=1.5, color='blue', label=r'8 Threads - $n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_1000, time_par_16_1000, linestyle='--', linewidth=1.5, color='orange', label=r'16 Threads - $n = 1000$')
plt.scatter(x_4000, time_par_16_4000, color='red')
plt.plot(x_4000, time_par_16_4000, linestyle='--', linewidth=1.5, color='red', label=r'16 Threads - $n = 4000$')
plt.scatter(x_10000, time_par_16_10000, color='purple')
plt.plot(x_10000, time_par_16_10000, linestyle='--', linewidth=1.5, color='purple', label=r'16 Threads - $n = 10000$')
plt.scatter(x_20000, time_par_16_20000, color='blue')
plt.plot(x_20000, time_par_16_20000, linestyle='--', linewidth=1.5, color='blue', label=r'16 Threads - $n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_1000, time_par_64_1000, linestyle='--', linewidth=1.5, color='orange', label=r'64 Threads - $n = 1000$')
plt.scatter(x_4000, time_par_64_4000, color='red')
plt.plot(x_4000, time_par_64_4000, linestyle='--', linewidth=1.5, color='red', label=r'64 Threads - $n = 4000$')
plt.scatter(x_10000, time_par_64_10000, color='purple')
plt.plot(x_10000, time_par_64_10000, linestyle='--', linewidth=1.5, color='purple', label=r'64 Threads - $n = 10000$')
plt.scatter(x_20000, time_par_64_20000, color='blue')
plt.plot(x_20000, time_par_64_20000, linestyle='--', linewidth=1.5, color='blue', label=r'64 Threads - $n = 20000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_1000, time_par_8_1000, linewidth=1.5, color='purple', label=r'8 Threads')
plt.scatter(x_1000, time_par_16_1000, linewidth=1.5, color='blue')
plt.plot(x_1000, time_par_16_1000, linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_1000, time_par_64_1000, linewidth=1.5, color='black')
plt.plot(x_1000, time_par_64_1000, linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_4000, time_par_8_4000, linewidth=1.5, color='purple', label=r'8 Threads')
plt.scatter(x_4000, time_par_16_4000, linewidth=1.5, color='blue')
plt.plot(x_4000, time_par_16_4000, linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_4000, time_par_64_4000, linewidth=1.5, color='black')
plt.plot(x_4000, time_par_64_4000, linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_10000, time_par_8_10000, linewidth=1.5, color='purple', label=r'8 Threads')
plt.scatter(x_10000, time_par_16_10000, linewidth=1.5, color='blue')
plt.plot(x_10000, time_par_16_10000, linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_10000, time_par_64_10000, linewidth=1.5, color='black')
plt.plot(x_10000, time_par_64_10000, linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')

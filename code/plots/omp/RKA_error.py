...
# python3 plots/omp/RKA_error.py 80000 1000 30000 30000 281.068 20000 25000 250 500
...
filename_1 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_50.txt"
...
filename_1 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_50.txt"
...
filename_fig = "RKA_error_" + str(M) + "_" + str(N)
...
filename_fig = "RKA_res_" + str(M) + "_" + str(N)

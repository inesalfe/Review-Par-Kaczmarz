...
plt.plot(alpha_2[:len(it_2_80000_4000_500)], it_2_80000_4000_500, linewidth=1.5, color='orange', label=r'Block Size = 500')
plt.scatter(alpha_2[:len(it_2_80000_4000_1000)], it_2_80000_4000_1000, color='red')
plt.plot(alpha_2[:len(it_2_80000_4000_1000)], it_2_80000_4000_1000, linewidth=1.5, color='red', label=r'Block Size = 1000')
plt.scatter(alpha_2[:len(it_2_80000_4000_4000)], it_2_80000_4000_4000, color='blue')
plt.plot(alpha_2[:len(it_2_80000_4000_4000)], it_2_80000_4000_4000, linewidth=1.5, color='blue', label=r'Block Size = 4000')
plt.grid()
plt.legend()
plt.yscale('log')
plt.xscale('log')
...
plt.plot(alpha_4[:len(it_4_80000_4000_500)], it_4_80000_4000_500, linewidth=1.5, color='orange', label=r'Block Size = 500')
plt.scatter(alpha_4[:len(it_4_80000_4000_1000)], it_4_80000_4000_1000, color='red')
plt.plot(alpha_4[:len(it_4_80000_4000_1000)], it_4_80000_4000_1000, linewidth=1.5, color='red', label=r'Block Size = 1000')
plt.scatter(alpha_4[:len(it_4_80000_4000_4000)], it_4_80000_4000_4000, color='blue')
plt.plot(alpha_4[:len(it_4_80000_4000_4000)], it_4_80000_4000_4000, linewidth=1.5, color='blue', label=r'Block Size = 4000')
plt.grid()
plt.legend()
plt.yscale('log')
plt.xscale('log')

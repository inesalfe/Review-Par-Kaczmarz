...
# python3 plots/omp/RK_parallel_M.py
...
plt.plot(x_80000[2::], time_par_1_80000[2::], linewidth=1.5, color='purple', label=r'1 Thread - $m = 80000$')
plt.scatter(x_160000[2::], time_par_1_160000[2::], color='blue')
plt.plot(x_160000[2::], time_par_1_160000[2::], linewidth=1.5, color='blue', label=r'1 Thread - $m = 160000$')
...
plt.plot(x_80000[2::], time_par_2_80000[2::], linestyle='--', linewidth=1.5, color='purple', label=r'2 Threads - $m = 80000$')
plt.scatter(x_160000[2::], time_par_2_160000[2::], color='blue')
plt.plot(x_160000[2::], time_par_2_160000[2::], linestyle='--', linewidth=1.5, color='blue', label=r'2 Threads - $m = 160000$')
plt.grid()
plt.legend()
...
plt.plot(x_80000[2::], time_par_4_80000[2::], linestyle='--', linewidth=1.5, color='purple', label=r'4 Threads - $m = 80000$')
plt.scatter(x_160000[2::], time_par_4_160000[2::], color='blue')
plt.plot(x_160000[2::], time_par_4_160000[2::], linestyle='--', linewidth=1.5, color='blue', label=r'4 Threads - $m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_80000[2::], time_par_8_80000[2::], linestyle='--', linewidth=1.5, color='purple', label=r'8 Threads - $m = 80000$')
plt.scatter(x_160000[2::], time_par_8_160000[2::], color='blue')
plt.plot(x_160000[2::], time_par_8_160000[2::], linestyle='--', linewidth=1.5, color='blue', label=r'8 Threads - $m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_20000[2::], time_par_16_20000[2::], linestyle='--', linewidth=1.5, color='orange', label=r'16 Threads - $m = 20000$')
plt.scatter(x_40000[2::], time_par_16_40000[2::], color='red')
plt.plot(x_40000[2::], time_par_16_40000[2::], linestyle='--', linewidth=1.5, color='red', label=r'16 Threads - $m = 40000$')
plt.scatter(x_80000[2::], time_par_16_80000[2::], color='purple')
plt.plot(x_80000[2::], time_par_16_80000[2::], linestyle='--', linewidth=1.5, color='purple', label=r'16 Threads - $m = 80000$')
plt.scatter(x_160000[2::], time_par_16_160000[2::], color='blue')
plt.plot(x_160000[2::], time_par_16_160000[2::], linestyle='--', linewidth=1.5, color='blue', label=r'16 Threads - $m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_20000[2::], time_par_64_20000[2::], linestyle='--', linewidth=1.5, color='orange', label=r'64 Threads - $m = 20000$')
plt.scatter(x_40000[2::], time_par_64_40000[2::], color='red')
plt.plot(x_40000[2::], time_par_64_40000[2::], linestyle='--', linewidth=1.5, color='red', label=r'64 Threads - $m = 40000$')
plt.scatter(x_80000[2::], time_par_64_80000[2::], color='purple')
plt.plot(x_80000[2::], time_par_64_80000[2::], linestyle='--', linewidth=1.5, color='purple', label=r'64 Threads - $m = 80000$')
plt.scatter(x_160000[2::], time_par_64_160000[2::], color='blue')
plt.plot(x_160000[2::], time_par_64_160000[2::], linestyle='--', linewidth=1.5, color='blue', label=r'64 Threads - $m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x_80000[2::], speedup_2_80000[2::], linewidth=1.5, color='purple', label=r'$m = 80000$')
plt.scatter(x_80000[2::], speedup_2_160000[2::], color='blue')
plt.plot(x_80000[2::], speedup_2_160000[2::], linewidth=1.5, color='blue', label=r'$m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_80000[2::], speedup_4_80000[2::], linewidth=1.5, color='purple', label=r'$m = 80000$')
plt.scatter(x_80000[2::], speedup_4_160000[2::], color='blue')
plt.plot(x_80000[2::], speedup_4_160000[2::], linewidth=1.5, color='blue', label=r'$m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_80000[2::], speedup_8_80000[2::], linewidth=1.5, color='purple', label=r'$m = 80000$')
plt.scatter(x_80000[2::], speedup_8_160000[2::], color='blue')
plt.plot(x_80000[2::], speedup_8_160000[2::], linewidth=1.5, color='blue', label=r'$m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_20000[2::], speedup_16_20000[2::], linewidth=1.5, color='orange', label=r'$m = 20000$')
plt.scatter(x_40000[2::], speedup_16_40000[2::], color='red')
plt.plot(x_40000[2::], speedup_16_40000[2::], linewidth=1.5, color='red', label=r'$m = 40000$')
plt.scatter(x_80000[2::], speedup_16_80000[2::], color='purple')
plt.plot(x_80000[2::], speedup_16_80000[2::], linewidth=1.5, color='purple', label=r'$m = 80000$')
plt.scatter(x_80000[2::], speedup_16_160000[2::], color='blue')
plt.plot(x_80000[2::], speedup_16_160000[2::], linewidth=1.5, color='blue', label=r'$m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_20000[2::], speedup_64_20000[2::], linewidth=1.5, color='orange', label=r'$m = 20000$')
plt.scatter(x_40000[2::], speedup_64_40000[2::], color='red')
plt.plot(x_40000[2::], speedup_64_40000[2::], linewidth=1.5, color='red', label=r'$m = 40000$')
plt.scatter(x_80000[2::], speedup_64_80000[2::], color='purple')
plt.plot(x_80000[2::], speedup_64_80000[2::], linewidth=1.5, color='purple', label=r'$m = 80000$')
plt.scatter(x_80000[2::], speedup_64_160000[2::], color='blue')
plt.plot(x_80000[2::], speedup_64_160000[2::], linewidth=1.5, color='blue', label=r'$m = 160000$')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_20000[2::], speedup_2_20000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_20000[2::], speedup_4_20000[2::], linewidth=1.5, color='orange')
plt.plot(x_20000[2::], speedup_4_20000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_20000[2::], speedup_8_20000[2::], linewidth=1.5, color='red')
plt.plot(x_20000[2::], speedup_8_20000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_20000[2::], speedup_16_20000[2::], linewidth=1.5, color='blue')
plt.plot(x_20000[2::], speedup_16_20000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_20000[2::], speedup_64_20000[2::], linewidth=1.5, color='black')
plt.plot(x_20000[2::], speedup_64_20000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_40000[2::], speedup_2_40000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_40000[2::], speedup_4_40000[2::], linewidth=1.5, color='orange')
plt.plot(x_40000[2::], speedup_4_40000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_40000[2::], speedup_8_40000[2::], linewidth=1.5, color='red')
plt.plot(x_40000[2::], speedup_8_40000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_40000[2::], speedup_16_40000[2::], linewidth=1.5, color='blue')
plt.plot(x_40000[2::], speedup_16_40000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_40000[2::], speedup_64_40000[2::], linewidth=1.5, color='black')
plt.plot(x_40000[2::], speedup_64_40000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_80000[2::], speedup_2_80000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_80000[2::], speedup_4_80000[2::], linewidth=1.5, color='orange')
plt.plot(x_80000[2::], speedup_4_80000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_80000[2::], speedup_8_80000[2::], linewidth=1.5, color='red')
plt.plot(x_80000[2::], speedup_8_80000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_80000[2::], speedup_16_80000[2::], linewidth=1.5, color='blue')
plt.plot(x_80000[2::], speedup_16_80000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_80000[2::], speedup_64_80000[2::], linewidth=1.5, color='black')
plt.plot(x_80000[2::], speedup_64_80000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_160000[2::], speedup_2_160000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_160000[2::], speedup_4_160000[2::], linewidth=1.5, color='orange')
plt.plot(x_160000[2::], speedup_4_160000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_160000[2::], speedup_8_160000[2::], linewidth=1.5, color='red')
plt.plot(x_160000[2::], speedup_8_160000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_160000[2::], speedup_16_160000[2::], linewidth=1.5, color='blue')
plt.plot(x_160000[2::], speedup_16_160000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_160000[2::], speedup_64_160000[2::], linewidth=1.5, color='black')
plt.plot(x_160000[2::], speedup_64_160000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_20000[2::], time_par_2_20000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_20000[2::], time_par_4_20000[2::], linewidth=1.5, color='orange')
plt.plot(x_20000[2::], time_par_4_20000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_20000[2::], time_par_8_20000[2::], linewidth=1.5, color='red')
plt.plot(x_20000[2::], time_par_8_20000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_20000[2::], time_par_16_20000[2::], linewidth=1.5, color='blue')
plt.plot(x_20000[2::], time_par_16_20000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_20000[2::], time_par_64_20000[2::], linewidth=1.5, color='black')
plt.plot(x_20000[2::], time_par_64_20000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_40000[2::], time_par_2_40000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_40000[2::], time_par_4_40000[2::], linewidth=1.5, color='orange')
plt.plot(x_40000[2::], time_par_4_40000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_40000[2::], time_par_8_40000[2::], linewidth=1.5, color='red')
plt.plot(x_40000[2::], time_par_8_40000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_40000[2::], time_par_16_40000[2::], linewidth=1.5, color='blue')
plt.plot(x_40000[2::], time_par_16_40000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_40000[2::], time_par_64_40000[2::], linewidth=1.5, color='black')
plt.plot(x_40000[2::], time_par_64_40000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_80000[2::], time_par_2_80000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_80000[2::], time_par_4_80000[2::], linewidth=1.5, color='orange')
plt.plot(x_80000[2::], time_par_4_80000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_80000[2::], time_par_8_80000[2::], linewidth=1.5, color='red')
plt.plot(x_80000[2::], time_par_8_80000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_80000[2::], time_par_16_80000[2::], linewidth=1.5, color='blue')
plt.plot(x_80000[2::], time_par_16_80000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_80000[2::], time_par_64_80000[2::], linewidth=1.5, color='black')
plt.plot(x_80000[2::], time_par_64_80000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')
...
plt.plot(x_160000[2::], time_par_2_160000[2::], linewidth=1.5, color='yellow', label=r'2 Threads')
plt.scatter(x_160000[2::], time_par_4_160000[2::], linewidth=1.5, color='orange')
plt.plot(x_160000[2::], time_par_4_160000[2::], linewidth=1.5, color='orange', label=r'4 Threads')
plt.scatter(x_160000[2::], time_par_8_160000[2::], linewidth=1.5, color='red')
plt.plot(x_160000[2::], time_par_8_160000[2::], linewidth=1.5, color='red', label=r'8 Threads')
plt.scatter(x_160000[2::], time_par_16_160000[2::], linewidth=1.5, color='blue')
plt.plot(x_160000[2::], time_par_16_160000[2::], linewidth=1.5, color='blue', label=r'16 Threads')
plt.scatter(x_160000[2::], time_par_64_160000[2::], linewidth=1.5, color='black')
plt.plot(x_160000[2::], time_par_64_160000[2::], linewidth=1.5, color='black', label=r'64 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.xscale('log')

...
ax.plot(x, it_par_2[0:8], linewidth=1.5, color='orange', label=r'Threads = 2')
ax.scatter(x, it_par_4[0:8], color='red')
ax.plot(x, it_par_4[0:8], linewidth=1.5, color='red', label=r'Threads = 4')
ax.scatter(x, it_par_8[0:8], color='purple')
ax.plot(x, it_par_8[0:8], linewidth=1.5, color='purple', label=r'Threads = 8')
ax.scatter(x, it_par_16[0:8], color='blue')
ax.plot(x, it_par_16[0:8], linewidth=1.5, color='blue', label=r'Threads = 16')
ax.scatter(x, it_par_64[0:8], color='black')
ax.plot(x, it_par_64[0:8], linewidth=1.5, color='black', label=r'Threads = 64')
...
axins.plot(x, it_par_2[0:8], linewidth=1.5, color='orange', label=r'Threads = 2')
axins.scatter(x, it_par_4[0:8], color='red')
axins.plot(x, it_par_4[0:8], linewidth=1.5, color='red', label=r'Threads = 4')
axins.scatter(x, it_par_8[0:8], color='purple')
axins.plot(x, it_par_8[0:8], linewidth=1.5, color='purple', label=r'Threads = 8')
axins.scatter(x, it_par_16[0:8], color='blue')
axins.plot(x, it_par_16[0:8], linewidth=1.5, color='blue', label=r'Threads = 16')
axins.scatter(x, it_par_64[0:8], color='black')
axins.plot(x, it_par_64[0:8], linewidth=1.5, color='black', label=r'Threads = 64')
...
ax.plot(x, it_par_2[48:56], linewidth=1.5, color='orange', label=r'Threads = 2')
ax.scatter(x, it_par_4[48:56], color='red')
ax.plot(x, it_par_4[48:56], linewidth=1.5, color='red', label=r'Threads = 4')
ax.scatter(x, it_par_8[48:56], color='purple')
ax.plot(x, it_par_8[48:56], linewidth=1.5, color='purple', label=r'Threads = 8')
ax.scatter(x, it_par_16[48:56], color='blue')
ax.plot(x, it_par_16[48:56], linewidth=1.5, color='blue', label=r'Threads = 16')
ax.scatter(x, it_par_64[48:56], color='black')
ax.plot(x, it_par_64[48:56], linewidth=1.5, color='black', label=r'Threads = 64')
...
axins.plot(x, it_par_2[48:56], linewidth=1.5, color='orange', label=r'Threads = 2')
axins.scatter(x, it_par_4[48:56], color='red')
axins.plot(x, it_par_4[48:56], linewidth=1.5, color='red', label=r'Threads = 4')
axins.scatter(x, it_par_8[48:56], color='purple')
axins.plot(x, it_par_8[48:56], linewidth=1.5, color='purple', label=r'Threads = 8')
axins.scatter(x, it_par_16[48:56], color='blue')
axins.plot(x, it_par_16[48:56], linewidth=1.5, color='blue', label=r'Threads = 16')
axins.scatter(x, it_par_64[48:56], color='black')
axins.plot(x, it_par_64[48:56], linewidth=1.5, color='black', label=r'Threads = 64')
axins.set_xlim(x[3]-30, x[3]+30)

...
plt.plot(x, time_par_2[0:8], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[0:8], color='red')
plt.plot(x, time_par_4[0:8], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[0:8], color='purple')
plt.plot(x, time_par_8[0:8], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[0:8], color='blue')
plt.plot(x, time_par_16[0:8], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[0:8], color='black')
plt.plot(x, time_par_64[0:8], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
...
plt.plot(x, time_par_2[8:16], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[8:16], color='red')
plt.plot(x, time_par_4[8:16], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[8:16], color='purple')
plt.plot(x, time_par_8[8:16], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[8:16], color='blue')
plt.plot(x, time_par_16[8:16], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[8:16], color='black')
plt.plot(x, time_par_64[8:16], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[16:24], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[16:24], color='red')
plt.plot(x, time_par_4[16:24], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[16:24], color='purple')
plt.plot(x, time_par_8[16:24], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[16:24], color='blue')
plt.plot(x, time_par_16[16:24], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[16:24], color='black')
plt.plot(x, time_par_64[16:24], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[24:32], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[24:32], color='red')
plt.plot(x, time_par_4[24:32], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[24:32], color='purple')
plt.plot(x, time_par_8[24:32], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[24:32], color='blue')
plt.plot(x, time_par_16[24:32], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[24:32], color='black')
plt.plot(x, time_par_64[24:32], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[32:40], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[32:40], color='red')
plt.plot(x, time_par_4[32:40], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[32:40], color='purple')
plt.plot(x, time_par_8[32:40], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[32:40], color='blue')
plt.plot(x, time_par_16[32:40], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[32:40], color='black')
plt.plot(x, time_par_64[32:40], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[40:48], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[40:48], color='red')
plt.plot(x, time_par_4[40:48], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[40:48], color='purple')
plt.plot(x, time_par_8[40:48], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[40:48], color='blue')
plt.plot(x, time_par_16[40:48], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[40:48], color='black')
plt.plot(x, time_par_64[40:48], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[48:56], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[48:56], color='red')
plt.plot(x, time_par_4[48:56], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[48:56], color='purple')
plt.plot(x, time_par_8[48:56], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[48:56], color='blue')
plt.plot(x, time_par_16[48:56], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[48:56], color='black')
plt.plot(x, time_par_64[48:56], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[56:64], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[56:64], color='red')
plt.plot(x, time_par_4[56:64], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[56:64], color='purple')
plt.plot(x, time_par_8[56:64], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[56:64], color='blue')
plt.plot(x, time_par_16[56:64], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[56:64], color='black')
plt.plot(x, time_par_64[56:64], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[64:72], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[64:72], color='red')
plt.plot(x, time_par_4[64:72], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[64:72], color='purple')
plt.plot(x, time_par_8[64:72], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[64:72], color='blue')
plt.plot(x, time_par_16[64:72], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[64:72], color='black')
plt.plot(x, time_par_64[64:72], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[72:80], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[72:80], color='red')
plt.plot(x, time_par_4[72:80], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[72:80], color='purple')
plt.plot(x, time_par_8[72:80], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[72:80], color='blue')
plt.plot(x, time_par_16[72:80], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[72:80], color='black')
plt.plot(x, time_par_64[72:80], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[80:88], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[80:88], color='red')
plt.plot(x, time_par_4[80:88], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[80:88], color='purple')
plt.plot(x, time_par_8[80:88], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[80:88], color='blue')
plt.plot(x, time_par_16[80:88], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[80:88], color='black')
plt.plot(x, time_par_64[80:88], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, time_par_2[88:96], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, time_par_4[88:96], color='red')
plt.plot(x, time_par_4[88:96], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, time_par_8[88:96], color='purple')
plt.plot(x, time_par_8[88:96], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, time_par_16[88:96], color='blue')
plt.plot(x, time_par_16[88:96], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, time_par_64[88:96], color='black')
plt.plot(x, time_par_64[88:96], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[0:8], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[0:8], color='red')
plt.plot(x, lines_par_4[0:8], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[0:8], color='purple')
plt.plot(x, lines_par_8[0:8], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[0:8], color='blue')
plt.plot(x, lines_par_16[0:8], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[0:8], color='black')
plt.plot(x, lines_par_64[0:8], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[8:16], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[8:16], color='red')
plt.plot(x, lines_par_4[8:16], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[8:16], color='purple')
plt.plot(x, lines_par_8[8:16], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[8:16], color='blue')
plt.plot(x, lines_par_16[8:16], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[8:16], color='black')
plt.plot(x, lines_par_64[8:16], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[16:24], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[16:24], color='red')
plt.plot(x, lines_par_4[16:24], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[16:24], color='purple')
plt.plot(x, lines_par_8[16:24], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[16:24], color='blue')
plt.plot(x, lines_par_16[16:24], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[16:24], color='black')
plt.plot(x, lines_par_64[16:24], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[24:32], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[24:32], color='red')
plt.plot(x, lines_par_4[24:32], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[24:32], color='purple')
plt.plot(x, lines_par_8[24:32], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[24:32], color='blue')
plt.plot(x, lines_par_16[24:32], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[24:32], color='black')
plt.plot(x, lines_par_64[24:32], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[32:40], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[32:40], color='red')
plt.plot(x, lines_par_4[32:40], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[32:40], color='purple')
plt.plot(x, lines_par_8[32:40], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[32:40], color='blue')
plt.plot(x, lines_par_16[32:40], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[32:40], color='black')
plt.plot(x, lines_par_64[32:40], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[40:48], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[40:48], color='red')
plt.plot(x, lines_par_4[40:48], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[40:48], color='purple')
plt.plot(x, lines_par_8[40:48], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[40:48], color='blue')
plt.plot(x, lines_par_16[40:48], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[40:48], color='black')
plt.plot(x, lines_par_64[40:48], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[48:56], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[48:56], color='red')
plt.plot(x, lines_par_4[48:56], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[48:56], color='purple')
plt.plot(x, lines_par_8[48:56], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[48:56], color='blue')
plt.plot(x, lines_par_16[48:56], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[48:56], color='black')
plt.plot(x, lines_par_64[48:56], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[56:64], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[56:64], color='red')
plt.plot(x, lines_par_4[56:64], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[56:64], color='purple')
plt.plot(x, lines_par_8[56:64], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[56:64], color='blue')
plt.plot(x, lines_par_16[56:64], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[56:64], color='black')
plt.plot(x, lines_par_64[56:64], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[64:72], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[64:72], color='red')
plt.plot(x, lines_par_4[64:72], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[64:72], color='purple')
plt.plot(x, lines_par_8[64:72], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[64:72], color='blue')
plt.plot(x, lines_par_16[64:72], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[64:72], color='black')
plt.plot(x, lines_par_64[64:72], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[72:80], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[72:80], color='red')
plt.plot(x, lines_par_4[72:80], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[72:80], color='purple')
plt.plot(x, lines_par_8[72:80], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[72:80], color='blue')
plt.plot(x, lines_par_16[72:80], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[72:80], color='black')
plt.plot(x, lines_par_64[72:80], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[80:88], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[80:88], color='red')
plt.plot(x, lines_par_4[80:88], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[80:88], color='purple')
plt.plot(x, lines_par_8[80:88], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[80:88], color='blue')
plt.plot(x, lines_par_16[80:88], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[80:88], color='black')
plt.plot(x, lines_par_64[80:88], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, lines_par_2[88:96], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, lines_par_4[88:96], color='red')
plt.plot(x, lines_par_4[88:96], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, lines_par_8[88:96], color='purple')
plt.plot(x, lines_par_8[88:96], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, lines_par_16[88:96], color='blue')
plt.plot(x, lines_par_16[88:96], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, lines_par_64[88:96], color='black')
plt.plot(x, lines_par_64[88:96], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
plt.plot(x, it_par_2[0:8], linewidth=1.5, color='orange', label=r'Threads = 2', marker='s', markersize=10)
# plt.scatter(x, it_par_4[0:8], color='red')
plt.plot(x, it_par_4[0:8], linewidth=1.5, color='red', label=r'Threads = 4', marker='^', markersize=10)
# plt.scatter(x, it_par_8[0:8], color='purple')
plt.plot(x, it_par_8[0:8], linewidth=1.5, color='purple', label=r'Threads = 8', marker='X', markersize=10)
# plt.scatter(x, it_par_16[0:8], color='blue')
plt.plot(x, it_par_16[0:8], linewidth=1.5, color='blue', label=r'Threads = 16', marker='^', markersize=10)
# plt.scatter(x, it_par_64[0:8], color='black')
plt.plot(x, it_par_64[0:8], linewidth=1.5, color='black', label=r'Threads = 64', marker='v', markersize=10)
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')

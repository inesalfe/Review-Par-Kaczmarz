...
# python3 plots/omp/RKAB_error.py 80000 1000 30 30 281.068 20 25 250 500
...
filename_1 = "errors/omp/RKAB_error_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/omp/RKAB_error_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/omp/RKAB_error_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/omp/RKAB_error_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/omp/RKAB_error_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/omp/RKAB_error_" + str(M) + "_" + str(N) + "_50.txt"
...
filename_1 = "errors/omp/RKAB_res_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/omp/RKAB_res_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/omp/RKAB_res_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/omp/RKAB_res_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/omp/RKAB_res_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/omp/RKAB_res_" + str(M) + "_" + str(N) + "_50.txt"
...
filename_fig = "RKAB_error_" + str(M) + "_" + str(N)
...
filename_fig = "RKAB_res_" + str(M) + "_" + str(N)
